...
execute join(['function! vital#_ddu_ui_ff_vim_popup#Keymapper#import() abort', printf("return map({'new': ''}, \"vital#_ddu_ui_ff_vim_popup#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
const s:state = {
  \ 'done': 1,
